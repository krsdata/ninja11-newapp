...
class UpcomingMatchesAdapter(
    ...
    override fun onBindViewHolder(parent: RecyclerView.ViewHolder, viewType: Int) {
        ...
        if (objectVal.is_dashboard) {
            ...
            viewHolder.contestLeaderBoard.visibility = View.GONE
        }

        if (objectVal.notification != null && objectVal.notification.isNotEmpty()) {
            viewHolder.messageView.visibility = View.VISIBLE
            viewHolder.messageView.text = objectVal.notification
        } else {
            viewHolder.messageView.visibility = View.GONE
        }
    }
