...
import fancode.cricks.databinding.ActivityContestLeaderBoardBinding
...
class ContestLeaderBoardActivity : AppCompatActivity() {
    ...
    override fun onCreateOptionsMenu(menu: Menu): Boolean {
        menuInflater.inflate(R.menu.contest_leaderboard_menu, menu)
        infoMenu = menu.findItem(R.id.filter_rank_info)
        infoMenu!!.isVisible = false
        return true
    }
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            ...
            R.id.filter_rank_info -> try {
                showRankBreakup(childDataList[0].match_name, childDataList[0].rank)
            } catch (e: Exception) {
                e.printStackTrace()
            }
        }
                ...
                override fun onResponse(
                    ...
                    if (res.getBoolean("status")) {
                        ...
                        if (res.getInt("code") == 1001) {
                            ...
                            MyUtils.logoutApp(this@ContestLeaderBoardActivity)
                        } else {
                            MyUtils.showMessage(
                                this@ContestLeaderBoardActivity,
                                res.getString("message")
    ...
    internal class PriceBreakupAdapter(
        ...
        /*fun updateDataRecord(arrayList: ArrayList<RankModel>) {
