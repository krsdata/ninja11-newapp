...
import mega.cricks.payments.PaytmHandler
...
import mega.cricks.utils.BindingUtils.Companion.GOOGLE_TEZ_PACKAGE_NAME
...
import mega.cricks.databinding.ActivityAddMoneyBinding
...
//            .getString("token")
    ...
    private fun payUsingPhonePay(amount : Double) {
        ...
        MyUtils.showMessage(this@AddMoneyActivity,"PhonePay coming soon , please soon paytm or Gpay")
    }
    ...
    private fun payUsingGooglePay(amount : Double) {
        ...
        if (isAppInstalled(GOOGLE_TEZ_PACKAGE_NAME)) {
            ...
            val uri = Uri.Builder()
                ...
                .appendQueryParameter("pn", "Bow1out11 grocory service")
