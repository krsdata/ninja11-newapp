...
import mega.cricks.adaptors.SelectedTeamAdapter
import mega.cricks.models.MyTeamModels
import mega.cricks.databinding.ActivitySelectTeamBinding
import mega.cricks.models.SelectedTeamModels
...
import mega.cricks.ui.JoinContestDialogFragment
            ...
            .enqueue(object : Callback<UsersPostDBResponse?> {
                ...
                override fun onResponse(
                    ...
                    if(res!=null) {
                        ...
                        adapter = SelectedTeamAdapter(this@SelectTeamActivity,matchObject,customeProgressDialog!!,
                            selectedTeamList
                        )
                        mBinding!!.recyclerSelectTeam.adapter = adapter
                    }
