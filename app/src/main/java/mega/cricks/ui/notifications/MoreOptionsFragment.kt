package mega.cricks.ui.notifications
...
import mega.cricks.databinding.FragmentMoreoptionsBinding
import mega.cricks.models.MoreOptionsModel
...
class MoreOptionsFragment : BaseFragment(){
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mBinding!!.appVersion.text = MyUtils.getAppVersionName(activity!!)
