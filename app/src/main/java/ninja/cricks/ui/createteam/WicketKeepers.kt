...
import ninja.cricks.CreateTeamActivity.Companion.MAX_PLAYERS_FROM_TEAM
import ninja.cricks.CreateTeamActivity.Companion.MAX_WICKET_KEEPER
import ninja.cricks.CreateTeamActivity.Companion.TEAMA
import ninja.cricks.CreateTeamActivity.Companion.TEAMB
...
class WicketKeepers : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        mBinding!!.labelPlayersCounts.text =  String.format( "Select %d - %d Wicket Keeper",
